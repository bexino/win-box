# ---------------------------------------------------------------------------------
# Script Name: DisableHonorSilentUpdate.ps1
# Description: One-click script to disable all known silent updates and block domains
# ---------------------------------------------------------------------------------
...
Write-Host "Running with Administrator privileges. Executing blocker strategies..." -ForegroundColor Green
...
# 3. Hosts Domain Blocking
$HostsPath = "$env:windir\System32\drivers\etc\hosts"
$BlockDomains = @(
    "configserver-drcn.platform.hihonorcloud.com",
